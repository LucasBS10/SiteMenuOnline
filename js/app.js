...
var VALOR_ENTREGA = 5;
var CELULAR_EMPRESA = '5585982014995';
...
cardapio.metodos = {
    ...
    // contem a lista de itens do cardapio
    ...
    adicionarAoCarrinho: (id) => {
        ...
        if(qntdAtual > 0) {
            ...
            if(item.length > 0) {
                ...
                // validar se já existem esse item no carrinho
                let existe = $.grep(MEU_CARRINHO, (elem, index) => { return elem.id == id});

                // caso já exita o item no carrinho, só altera a quantidade
                if(existe.length > 0 ) {
    ...
    removerItemCarrinho: (id) => {
        ...
        //atualiza o botão carrinho com a quandade atual
        cardapio.metodos.atualizarBadgeTotal();
        
    },

    //atualizar o carrinho com a quantdade atual..
    ...
    //Atualiza o link do botão do whatzapp
    finalizarPedido: () => {
    ...
    // carrega o link do botão whatsapp.
    carregarBotaoWhatsapp: () => {

        var texto = 'Olá! gostaria de tirar algumas dúvidas ?';
        ...
        <div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-5 animated fadeInUp">
            <div class="card card-item" id="\${id}">
                ...
                <div class="add-carrinho">
                    <span class="btn-menos" onclick="cardapio.metodos.diminuirQua ntidade('\${id}')"><i class="fas fa-minus"></i></span>
